...
<body>
 ...
 <a id="back" href="Customerhomepage.jsp" class="btn btn-primary">Back</a>
	<div class="row">
		<div class="col-md-6">
		...
		<div class="col-md-6">
			...
			<div>
				<a href="Purchase.jsp" class="btn btn-primary" id="buy">Buy</a>
				<form action="Cart" method="post">
				<button type="submit" onclick="alert('Item successfully added into the cart');" class="btn btn-warning" id="addkart">Add to cart</button>
				</form>
			</div>
		</div>
	</div>
