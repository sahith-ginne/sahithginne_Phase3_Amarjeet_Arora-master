...
<div class="row">
 ...
 Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/Sportyshoes","root","sahith");
    ...
    <%
		...
		PreparedStatement ps=con1.prepareStatement("insert into Billpage(Company,Category,Price,Username,Address,Ordereddate)values(?,?,?,?,?,?)");
    ...
    <div style="margin:0px 40px;"><a href="Customerhomepage.jsp" class="btn btn-primary">Continue Shoping</a></div>
    </div>
</body>
</html>